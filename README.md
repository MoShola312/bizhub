...
The tools used to create this game are Javascript, JSON, AJAX, Bootstrap 4, jQuery, EJS, Mongoose, MongoDB, Node.js, Express, Passport, HTML, CSS, and DOM maniputlation.
